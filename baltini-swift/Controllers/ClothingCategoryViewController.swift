//
//  ClothingCategoryViewController.swift
//  baltini-swift
//
...
class ClothingCategoryViewController: UIViewController {
    
    private let clothingData = [
        "Man" : ["Coats & Jackets", "Jeans", "Pants & Shorts", "Shirts", "Suits", "Sweaters", "Swimwear", "Topwear"],
        "Woman": ["Coats & Jackets", "Dresses", "Jumpsuits", "Jeans", "Lingerie", "Pants & Shorts", "Shirts", "Skirts", "Sweaters", "Swimwear", "Topwear"]
    ]
...
extension ClothingCategoryViewController {
