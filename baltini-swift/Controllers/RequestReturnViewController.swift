//
//  RequestReturnViewController.swift
//  baltini-swift
//
...
class RequestReturnViewController : UIViewController {
...
extension RequestReturnViewController {
    func createUI(){
        ...
        let backButton = BackButton.createBackButton(title: "Request a Return" , icName: "icBack", usePadding: true, tapped: UIAction(handler: { action in
