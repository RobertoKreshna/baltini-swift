//
//  ShoesCategoryViewController.swift
//  baltini-swift
//
...
class ShoesCategoryViewController: UIViewController {
    
    private let clothingData = [
        "Man" : ["Boots", "Laced Up", "Loafers", "Sandals", "Sneakers"],
        "Woman": ["Boots", "Flats", "Heels", "Laced Up", "Loafers", "Pumps", "Sandals", "Sneakers", "Wedges"]
    ]
...
extension ShoesCategoryViewController {
