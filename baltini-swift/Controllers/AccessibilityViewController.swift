...
//  baltini-swift
//
//  Created by Roberto Kreshna on 13/12/23.
//
...
extension AccessibilityViewController {
    func createUI(){
        ...
        let backButton = BackButton.createBackButton(title: "Accessibility Statement" , icName: "icBack", usePadding: true, tapped: UIAction(handler: { action in
