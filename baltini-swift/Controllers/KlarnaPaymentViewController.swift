...
extension KlarnaPaymentViewController {
    func createUI(){
        ...
        let backButton = BackButton.createBackButton(title: "Klarna Payment" , icName: "icBack", usePadding: true, tapped: UIAction(handler: { action in
